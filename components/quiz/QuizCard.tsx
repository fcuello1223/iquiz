...
function QuizCard({ quiz }: Props) {
  ...
  return (
    <div className="cursor-pointer border-2 rounded-xl p-1 shadow-[0_.3rem_0_0_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-transform duration-300 ease-in-out" onClick={handleClick}>
